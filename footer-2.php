<footer class="p-3 py-5 text-dark bg-light w-100">
    ...
    <div class="row justify-content-between">
      ...
      <div class="col-lg-2 col-sm-12">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li>神奈川県川崎市多摩区</li>
          <li>東生田1丁目13 - 1</li>
          <li class="mt-3">TEL : 044-933-1511</li>
          <li class="mt-3">FAX : 044-933-1905</li>
      ...
      <div class="col-lg-2 col-sm-12">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li class="mt-2"><a class="text-muted" href="page-about#bigbox-03">Global Mocom<br/>Transcending Inc<br/>(GMTI)</a></li>
  ...
  <div class="row">
    <div class="col w-100" id="copyright">
      <h7 id="copyrightinner">©<?php echo date('Y'); ?> , MOCOM CO., LTD.</h7>
    </div>
  </div>
</footer>
