...
<i class="fas fa-angle-double-up" id="back" onclick="back()"></i>
  ...
  <div class="container mt-3 w-100" id="companybox">
    <div class="row">
      <div class="col-lg-6">
        <div class="col-12-sm">
          <figure class="figure">
          <img src="<?php bloginfo('template_directory'); ?>/images/refadmin-p-500.png" style="height:333px" class="figure-img img-fluid">
        </figure>
      ...
      <div class="col-lg-6">
        <div class="col-12-sm">
          <figure class="figure">
          <img src="<?php bloginfo('template_directory'); ?>/images/domsales-p-500.png"  class="figure-img img-fluid">
        </figure>
  ...
  <div class="container mt-3 w-100" id="companybox">
    <div class="row">
      <div class="col-lg-4">
        <div class="col-12-sm">
          <div class="imgWrap">
          <img src="<?php bloginfo('template_directory'); ?>/images/fdesign-p-500.png" width="330px" height="200px">
          </div>  
      ...
      <div class="col-lg-4">
        <div class="col-12-sm">
        <div class="imgWrap">
          <img src="<?php bloginfo('template_directory'); ?>/images/prosupport-p-500.jpeg" width="330px" height="200px">
        </div>
      ...
      <div class="col-lg-4">
        <div class="col-12-sm">
        <div class="imgWrap">
          <img src="<?php bloginfo('template_directory'); ?>/images/consult.JPG" width="330px" height="200px">
        </div>
  ...
  <script type="text/javascript">
    ...
    function move3() {
      document.getElementById("bigbox-03").scrollIntoView({behavior: 'smooth' });
    };
    function back(){
