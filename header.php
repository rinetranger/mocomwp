...
<head>
  ...
  <meta name="description" content="株式会社モコムは、設計、調達から製造、解析評価、設備開発まで インテグレーションの豊富な経験を活かし、お客様の様々なご要望に対応致します。お問い合わせはTEL : 044-933-1511　株式会社モコムまで">
...
<body>
  ...
  <header class="w-100">
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <button class="navbar-toggler toggler-example" type="button" data-toggle="collapse" data-target="#navbarSupportedContent1" aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation"><span class="dark-blue-text"><i class="fas fa-bars fa-1x"></i></span>
      </button>
      ...
      <a class="nav-link w-100  m-1" id="links" href="page-about">事業内容</a>
          ...
          <li class="w-20 nav-item dropdown">
            <a class="nav-link w-100 m-1 dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">事業内容</a>
      ...
      <a class="nav-link w-100 m-1" id="links"  href="page-info">企業情報</a>
          ...
          <li class="w-20 nav-item dropdown">
            <a class="nav-link w-100 m-1 dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">企業情報</a>
            <div class="dropdown-menu dropdown-primary p-2" aria-labelledby="navbarDropdownMenuLink">
